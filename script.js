...
if (avatar) {
    window.addEventListener('mousemove', (e) => {
        ...
        avatar.style.transform = `translateY(-20px) rotateX(${y}deg) rotateY(${x}deg)`;
    });
}

// Scroll animations
const scrollReveal = () => {
    const reveals = document.querySelectorAll('.hero-content, .about-content');
...
// Add smooth reveal class styles
